...
3. Identify only current, developer-relevant updates supported by those official sources. Preserve the existing Markdown structure and editorial angle, and cite the GitHub Blog or Changelog source for every added or materially changed item.
